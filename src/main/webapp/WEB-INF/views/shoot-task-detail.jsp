                ...
                <div class="shoot-info-sections">
                    <div>
                        ...
                        <div class="info-list">
                            ...
                            <%-- Cameraperson Mark - the one predefined role mark relevant to this
                                 screen (set once at Idea Review approval, PredefinedRoleMarks). --%>
                            <div class="info-row"><span class="summary-field-label">Mark</span><span class="summary-field-value">
                                <c:choose>
                                    <c:when test="${not empty marks}"><c:out value="${marks.predefinedCameramanMark}"/></c:when>
                                    <c:otherwise>&mdash;</c:otherwise>
                                </c:choose>
                            </span></div>
                        </div>
